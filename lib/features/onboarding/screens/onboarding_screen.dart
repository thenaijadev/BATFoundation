import 'package:bat_foundation/features/onboarding/widgets/onboarding_page.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Widget> _pages = [
    const OnboardingPageWidget(
      ...
      description:
          "Keep up to date with our events as they happen.Don't forget to registerso that you can be part of our stories as we continue to make a difference.",
    ),
    const OnboardingPageWidget(
      image: "assets/images/news.jpg",
      title: "News update",
      description:
          "Get live update on the foundation's activities,press statement, news articles, videos and photos.",
    ),
    const OnboardingPageWidget(
