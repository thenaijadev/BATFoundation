...
import 'package:bat_foundation/features/home/presentation/widgets/category_buttion.dart';
              ...
              body: CustomScrollView(
                ...
                slivers: <Widget>[
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            ...
                            child: CategoryButton(title: categoryButtonData[index].buttonTitle ?? "",
                              color: selectedButton == index ? AppColors.primary : Colors.transparent, index: index,),
                          );
                        },
                      ),
                    ),
                  ...
                  SliverToBoxAdapter(child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      selectedButton == 0 ? const SizedBox() :
                      GestureDetector(
                        onTap: (){
                          if(selectedButton == 1){
